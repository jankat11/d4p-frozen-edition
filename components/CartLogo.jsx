    ...
    <Link href="/" className={`nav-link ${classes}`}>
      ...
      >
        ...
        <div className="indicator font-raleway">
          {/* <span className={`indicator-item badge absolute -top-[2px] px-[10px] right-[-3px] ${scrollDown || isMenuOpen ? " bg-[#6b593c] border-[#6b593c] text-white" : " border-aside text-primary"} transition-all duration-0 mb-2`}>
