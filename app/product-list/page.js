  ...
  return (
    <>
      ...
      <section className="py-10 pt-0">
        <div className="mx-auto grid gap-10 max-w-7xl grid-cols-1 p-4 sm:grid-cols-2  lg:grid-cols-3  xl:grid-cols-4">
          {data.map((product, i) => (
            <article
              key={i}
              className="relative flex flex-col justify-end border rounded-md shadow-md border-westar lg:first:col-span-2  lg:first:row-span-2  lg:hover:transform cursor-pointer "
            >
...
}
{
  /* 
                <div className="mt-1 p-2 ">
                  <h2 className="text-napaDark">Adobe Photoshop CC 2022</h2>
                  <p className="mt-1 text-sm text-napa">
                    Lisbon, Portugal
                  </p>
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1.5 rounded-lg px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                     

                      <button className="text-sm button-primary border font-light border-primary  px-2 py-2  flex items-center gap-2">Add to cart</button>
                    </div>
                  </div>
                </div> */
}

                {/* <div className="px-2 absolute bottom-8 text-sm font-light right-0 text-primary">
